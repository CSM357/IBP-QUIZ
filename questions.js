const questions = [
  ...
  },
  {
    id: 14,
    type: "mcq",
    question: "When maintaining the Business Partner information for the Supplier role, which organizational unit should be extended?",
    options: [
  ...
  },
  {
    ...
    options: ["Asset creation", "Asset acquisition", "Asset book value", "Depreciation run"],
    answer: [0, 3],
  },
  {
    id: 22,
  ...
  },
  {
    id: 25,
    type: "mcq",
    question: "During which process step are financial accounting documents posted when purchasing raw materials with a purchase order against a cost center?",
    options: [
      "Save purchase order",
  ...
  },
  {
    ...
    options: ["Plant", "Storage Bin", "Storage Type", "Storage Location"],
    answer: [1],
  },
  {
    id: 30,
  ...
  },
  {
    id: 53,
    type: "msq",
    question: "Which processes can be automatically performed when you post an order confirmation for a production order?",
    options: [
  ...
  },
  {
    id: 54,
    type: "msq",
    question: "Which characteristics must a new company code share with other company codes already assigned to the controlling area?",
    options: [
      "Fiscal year variant",
  ...
  },
  {
    id: 83,
    type: "msq",
    question: "What master data is used to calculate the quantity structure in product cost planning?",
  ...
  },
  {
    id: 85,
    type: "msq",
    question: "What are the results when a goods issue is posted against a production order?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "Change the material type appropriately",
    ],
    answer: [1],
  },
  {
  ...
  },
  {
    id: 100,
    type: "mcq",
    question: "Which organizational unit in SAP S/4HANA represents the highest level in the enterprise structure?",
    options: [
      "Company Code",
      "Client",
      "Plant",
